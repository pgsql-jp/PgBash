...
/*=====================================================================
 * This file was modified by SAKAIDA Masaaki.
 *
 * Change Log
 * 1. Change "select" to "selects" in STRING_INT_ALIST.
 * 2. Change read_token() in yylex() to read_EXEC_SQL_token().
 * 3. Add read_EXEC_SQL_token() routines.
 *
 *=====================================================================
 */
