 ...
 *
 * Change Logs
 * 1. Add pgbashrc_file(~/.pgbashrc) and etc_pgbashrc_file(/etc/pgbashrc)
 * 2. Add 'maybe_execute_file(pgbashrc_file, 1);'.
 * 3. Add 'maybe_execute_file(etc_pgbashrc_file, 1);'.
 * 4. If pgbashrc_file and etc_pgbashrc_file are not exist, then
 *    print error message.
 *
 *===================================================================
 */
...
static char *pgbashrc_file = "~/.pgbashrc";
static char *etc_pgbashrc_file = "/etc/pgbashrc";
...
#  endif
      ...
      if (maybe_execute_file (pgbashrc_file, 1)==0)
      {
          if (maybe_execute_file (etc_pgbashrc_file, 1)==0)
              fprintf(stderr, "Error: %s or %s not found.\n\n",
              pgbashrc_file, etc_pgbashrc_file );
      }
	  return;
	}
    }
...
shell_reinitialize ()
{
  ...
  bashrc_file = "~/.bashrc";
  pgbashrc_file = "~/.pgbashrc";
  etc_pgbashrc_file = "/etc/pgbashrc";
